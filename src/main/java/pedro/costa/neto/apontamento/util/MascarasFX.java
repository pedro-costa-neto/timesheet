...
public class MascarasFX {
   ...
   public static void mascaraData(TextField textField){
       ...
       textField.setOnKeyReleased((KeyEvent evt) -> {
           ...
           if(!textField.getText().matches("\\d/*")){
               textField.setText(textField.getText().replaceAll("[^\\d/]", ""));
               Integer length = textField.getText().length();
               if(length < 10) {            	   
   ...
   public static void mascaraHora(TextField textField){
       ...
       textField.setOnKeyReleased((KeyEvent evt) -> {
           ...
           if(!textField.getText().matches("\\d\\d:\\d\\d")){
               textField.setText(textField.getText().replaceAll("[^\\d\\d:\\d\\d]", ""));
